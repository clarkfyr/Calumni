...
{:username => 'sam', :email => '3@gmail.com', :description => 'this is description3',:company => 'YC',:start_date => '2017/9/2',:major=>'Biology',:open_advice=>'advice 3',:avatar=>File.new("#{root}/app/assets/images/sam.jpg"),:helpability=>'resume',:position=>'investor'},
